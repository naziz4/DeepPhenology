# -*- coding: utf-8 -*-
"""
Created on Wed Feb 24 21:47:27 2021
...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 10 11:52:02 2021
...
model_output = pd.DataFrame(model_output, columns = [])
model_output['imagepaths'] = list(img_list['imagepaths'])
model_output.to_csv('/ihome/skuebbing/nza4/ml/csv/model_predictions_4.csv')
