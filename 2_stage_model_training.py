# -*- coding: utf-8 -*-
"""
Created on Wed Feb 24 21:38:40 2021
...
root_dir = '/ihome/skuebbing/nza4/ml/Training_Data'
...
model_ft = train_model(model_ft, criterion, optimizer_ft, exp_lr_scheduler,
                       num_epochs = 25)
torch.save(model_ft.state_dict(), '/ihome/skuebbing/nza4/ml/models/2_stage_model.pt')
writer.flush()
writer.close()
